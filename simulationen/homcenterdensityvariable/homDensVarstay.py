...
for dens in range(len(densvec)):
    ...
    experiment = RelaxExperiment(ceninst, evo_time, dxb_ratio=1/6., method="randomwalks",fake=False,walk_type="stay")
...
np.savetxt("staydens,T1,T1err,beta,betaerr.txt",T1dens)
