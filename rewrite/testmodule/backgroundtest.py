...
for bfield in np.array( [0.6, 1.22, 3.8] ):
    ...
    ranexperiment.run_experiment(walks=walks,background=7e-2)
    ...
    detexperiment.run_experiment(background=7e-2)
    ...
    #T1densran.append([bfield, detresult.fitT1, detresult.fitT1err, detresult.fitbeta, detresult.fitbetaerr])
...
fig.savefig('bgmag.pdf',format='pdf')
#fig2.savefig('bgt1.pdf',format='pdf')